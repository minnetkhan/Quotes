...
var QuotesProvider = /** @class */ (function () {
    function QuotesProvider(http, storage) {
        var _this = this;
        this.http = http;
        ...
        */
        ...
        this.storage.forEach(function (value, key, index) {
            console.log('provider constructor: ' + _this.favouriteQuotes);
            _this.favouriteQuotes.push(value);
        });
    }
    QuotesProvider.prototype.getQuoteOfTheDay = function () {
    ...
    QuotesProvider.prototype.setFavorite = function (quote) {
        var position = this.favouriteQuotes.findIndex(function (favoriteQuotesEl) { return favoriteQuotesEl.ID == quote.ID; });
        if (position == -1) {
            this.favouriteQuotes.push(quote);
            this.storage.set(quote.ID, quote);
        }
    };
    ...
    QuotesProvider.prototype.isQuoteFavorite = function (quote) {
        return this.favouriteQuotes.find(function (favoriteQuotesEl) { return favoriteQuotesEl.ID == quote.ID; });
    };
    QuotesProvider.prototype.removeFavoriteQuote = function (quote) {
        var position = this.favouriteQuotes.findIndex(function (favoriteQuotesEl) { return favoriteQuotesEl.ID == quote.ID; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_common_http__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_quotes_quotes__ = __webpack_require__(198);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/tonystark/Projects/IonicProjects/quotes/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/tonystark/Projects/IonicProjects/quotes/src/app/app.html"*/
        }),
